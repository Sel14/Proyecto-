...
notificar=Entry(frame,textvariable=notificar)
notificar.grid(row=5,column=3)
boton2=Button(frame, text="Notificar", command=lambda:send(notificar))#este boton sirve para notificar al mesero de la orden
